...
type Fans struct {
	MerchantNo     string    `gorm:"not null;type:varchar(80);index:idx_merchant_no_robot_wx_id_fans_wx_id" json:"merchant_no"`  //商户ID
	RobotWxId      string    `gorm:"not null;type:varchar(100);index:idx_merchant_no_robot_wx_id_fans_wx_id" json:"robot_wx_id"` //机器人微信ID
	FansWxId       string    `gorm:"not null;type:varchar(100);index:idx_merchant_no_robot_wx_id_fans_wx_id" json:"fans_wx_id"`  //好友微信ID
